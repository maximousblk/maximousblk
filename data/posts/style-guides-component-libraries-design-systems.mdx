...
<a aria-label="Ant Design Component Library" href="https://ant.design/">
  <Image
    alt={`Ant Design Component Library`}
    src={`/images/style-guides-component-libraries-design-systems/component-library.png`}
    width={1080}
    height={810}
    priority
  />
...
2.  [What is a Style Guide?](#what-is-a-style-guide)
3.  [What is a Component Library?](#what-is-a-component-library)
4.  [What is a Design System?](#what-is-a-design-system)
5.  [Where Should You Begin?](#where-should-you-begin)
6.  [Building the Design System](#building-the-design-system)
...
<a
  ...
  href="ttps://www.uxpin.com/studio/blog/design-systems-vs-pattern-libraries-vs-style-guides-whats-difference/"
>
  <Image
    alt={`Design System`}
...
Unless you are starting from scratch, you will need to identify all the [design patterns](https://pttrns.com/applications/86) currently in use in your interface and document any inconsistencies.
...
My recommendation would be **Sketch**, but it's ultimately up to your team and company. Make sure you understand [best practices around Sketch symbols](https://novemberfive.co/blog/symbols-guidelines-in-sketch/) and when to use [nesting](https://www.sketch.com/docs/symbols/nested-symbols/).
...
A [Monorepo](https://www.toptal.com/front-end/guide-to-monorepos) allows you to build and publish multiple libraries from a single repo.  While it does solve some very real problems, it also creates others. It's important to understand the pros and cons.
...
For most smaller companies, I would argue that a Monorepo is unnecessary. It has its time and place. [We use it at Hy-Vee](/blog/monorepo-lerna-yarn-workspaces) (~150 developers) to distribute 10 different packages at once, spanning both internal and external apps.

**Note:** Want to use a Monorepo? Check out [Creating a Monorepo with Lerna & Yarn Workspaces](/blog/monorepo-lerna-yarn-workspaces).

### Evaluate CSS/Sass vs. CSS-in-JS.

I've come to prefer CSS-in-JS, especially [styled-components](https://www.styled-components.com/). There's a variety of different CSS-in-JS options outlined [here](https://github.com/MicheleBertoli/css-in-js). The major selling points for styled-components for our component library were:
...
If your component library needs to support outputting raw HTML/CSS as an option, I would recommend sticking with Sass. A great example of this is IBM's [Carbon Design System](https://www.carbondesignsystem.com/components/button/code).
...
Regardless of the technology you choose, I would recommend using [CSS variables](https://developer.mozilla.org/en-US/docs/Web/CSS/Using_CSS_custom_properties) to contain your [design tokens](https://www.lightningdesignsystem.com/design-tokens/).
...
- Will your components need to support web _and_ mobile? Consider using [React Native Web](https://github.com/devhubapp/devhub) to share code across platforms.
